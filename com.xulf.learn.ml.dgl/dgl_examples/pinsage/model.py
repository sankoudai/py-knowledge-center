...
def train(dataset, args):
    ...
    # Sampler
    # batch_sampler 实际是g上随机游走得到的dataset: 元素(heads, pos_tails, neg_tails)
    # heads--随机,
    # pos_tails--heads沿指定metapath游走得到,
    # neg_tail--随机
    batch_trainset = sampler_module.ItemToItemBatchSampler(
        g, user_ntype, item_ntype, args.batch_size)

    # 从(heads, tails, neg_tails) => pos_graph, neg_graph, blocks
    #  pos_graph -- (head, tails)
    # neg_graph -- (head, neg_tails)
    # blocks: xxx
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, default='./data/data.pkl')
